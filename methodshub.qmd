...
* Automated collection of search engine results
* Longitudinal monitoring of search engine result changes
* Comparison of results from different search engines
...
In case of questions, contact [Roberto Ulloa](mailto:roberto.ulloa@gesis.org).
