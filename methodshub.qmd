...
A browser extension for Mozilla and Chrome that searches and saves **main, news, images, and videos** results of up to 8 different [search engines](#supported-engines). For example, the extension can be installed on [Firefox](#firefox) or [Chrome](#chrome). After selecting [search engines and keywords](#step-1-adjusting-the-settings), you can [start crawling](#step-2-start-crawling). Once you have [saved accessed pages](#saving-search-results) into downloads, you can [deactivate](#reload-deactivate-or-remove) the extension.
...
Once you have gathered all data needed, stop crawling by [deactivating or removing the extension](#reload-deactivate-or-remove).
